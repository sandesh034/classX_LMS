...
const { postAssignment, submitAssignment, gradeAssignment, obtainSubmittedAssignment, getAssignmentOfCourse } = require('../controllers/assignment.controller')

router.post('/post/:course_id', checkAuth, checkInstructor, checkInstructorEnrollment, upload.single('attachment'), postAssignment)
router.get('/get/:course_id', checkAuth, checkEnrollment, getAssignmentOfCourse)
